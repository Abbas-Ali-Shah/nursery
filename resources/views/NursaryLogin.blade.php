						...
						<div class="single-page">
							<div class="">
								<div class="wrapper wrapper2">
									<form id="login"  tabindex="500"  action="{{ url('nurserysignin') }}" method="post">
									@csrf
										<h3 class="text-dark">Nursery Login</h3>
										<div class="mail">
										...
										<div class="signup mb-0" >
											<p class="text-dark mb-0">Don't have account?<a href="{{ url('sign_up_nursery') }}" class="text-primary ml-1">Sign UP</a></p>
										</div>
									</form>
