			...
			<section class="section ">
                <div class="container">
					<div class="">
						...
						<!--single-page open-->
						<div class="single-page"> m
							<div class="">
								<div class="wrapper wrapper2">
									<form id="login" class="card-body" tabindex="500" action="{{ route('sigupN.Addsign') }}" method="post">
                                        @csrf
                                        ...
                                        <div class="mail">
											<input type="text"  name ="loction" class="form-control" id="exampleInputEmail1" placeholder="Enter Address">
										</div>
                                        <div class="mail">
											<input type="text"  name ="phone" class="form-control" id="exampleInputEmail1" placeholder="Enter Phone Number">
										</div>
                                        <div class="mail">
											<input type="text"  name ="whatappno" class="form-control" id="exampleInputEmail1" placeholder="Enter whatapp No">
										</div>
										<div class="mail">
											<input type="email"  name ="email" class="form-control" id="exampleInputEmail1" placeholder="Enter whatapp No">
										</div>
										<div class="passwd">
